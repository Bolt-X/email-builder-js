...
const STANDARD_FONT_FAMILY =
	'"Be Vietnam Pro",-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol"';
const MONOSPACE_FONT_FAMILY =
	'"Be Vietnam Pro",ui-monospace, Menlo, Monaco, "Cascadia Mono", "Segoe UI Mono", "Roboto Mono", "Oxygen Mono", "Ubuntu Monospace", "Source Code Pro", "Fira Mono", "Droid Sans Mono", "Courier New", monospace';
...
export const getTheme = (mode: "light" | "dark") => {
	...
	const BASE_THEME = createTheme({
		palette: {
			mode,
			background: {
				default: isDark ? "#08080A" : "#FAFAFA",
				paper: isDark ? "#121217" : "#FFFFFF",
			},
			text: {
				primary: isDark ? "#FFFFFF" : "#1F1F21",
				secondary: isDark ? "#B0B0B0" : "#4F4F4F",
			},
	...
	return createTheme(BASE_THEME, {
		palette: {
			...
			neutral: {
				black: {
					0: "rgba(0,0,0,0)",
					5: isDark ? "rgba(255,255,255,0.05)" : "rgba(0,0,0,0.05)",
					10: isDark ? "rgba(255,255,255,0.10)" : "rgba(0,0,0,0.10)",
					15: isDark ? "rgba(255,255,255,0.15)" : "rgba(0,0,0,0.15)",
					20: isDark ? "rgba(255,255,255,0.20)" : "rgba(0,0,0,0.20)",
					25: isDark ? "rgba(255,255,255,0.25)" : "rgba(0,0,0,0.25)",
					30: isDark ? "rgba(255,255,255,0.30)" : "rgba(0,0,0,0.30)",
					35: isDark ? "rgba(255,255,255,0.35)" : "rgba(0,0,0,0.35)",
					40: isDark ? "rgba(255,255,255,0.40)" : "rgba(0,0,0,0.40)",
					45: isDark ? "rgba(255,255,255,0.45)" : "rgba(0,0,0,0.45)",
					50: isDark ? "rgba(255,255,255,0.50)" : "rgba(0,0,0,0.50)",
					55: isDark ? "rgba(255,255,255,0.55)" : "rgba(0,0,0,0.55)",
					60: isDark ? "rgba(255,255,255,0.60)" : "rgba(0,0,0,0.60)",
					65: isDark ? "rgba(255,255,255,0.65)" : "rgba(0,0,0,0.65)",
					70: isDark ? "rgba(255,255,255,0.70)" : "rgba(0,0,0,0.70)",
					75: isDark ? "rgba(255,255,255,0.75)" : "rgba(0,0,0,0.75)",
					80: isDark ? "rgba(255,255,255,0.80)" : "rgba(0,0,0,0.80)",
					85: isDark ? "rgba(255,255,255,0.85)" : "rgba(0,0,0,0.85)",
					90: isDark ? "rgba(255,255,255,0.90)" : "rgba(0,0,0,0.90)",
					95: isDark ? "rgba(255,255,255,0.95)" : "rgba(0,0,0,0.95)",
					100: isDark ? "#FFFFFF" : "#000000",
				},
			},
		},
		components: {
      ...
      `,
				...
				styleOverrides: {
					root: {
						...
						"&.Mui-focused .MuiOutlinedInput-notchedOutline": {
							borderColor: isDark ? "#FFFFFF" : BRAND_BLUE,
						},
					},
					notchedOutline: {
						"& legend": {
		...
		typography: {
			...
			MuiTooltip: {
				styleOverrides: {
					tooltip: {
						backgroundColor: isDark ? "#4F4F4F" : "#1F1F21",
						color: "#FFFFFF",
						fontSize: "0.75rem",
						fontWeight: 600,
						padding: "6px 10px",
